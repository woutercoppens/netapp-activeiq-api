...
if __name__ == "__main__":
    ...
    with open("/home/wouter/netapp/customers.csv", "r") as read_obj:
        ...
        for row in csv_dict_reader:
            ...
            tablesl = tablesl.append(clean_data(systems))
        # pprint(tablesl)
    ...
    with open("/home/wouter/netapp/systems.csv", "r") as read_obj:
        ...
        for row in csv_dict_reader:
            ...
            results.update(extra_data)  # add the serial number to the efficiency data
            tablesl = tablesl.append(results, ignore_index=True)
        pprint(tablesl)
